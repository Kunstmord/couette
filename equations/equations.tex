...
Если считать, что вращательная энергия не зависит от колебательной, то
...
Далее будем пользоваться этим предположением. Тогда уравнение энергии принимает вид

\begin{multline}
  - \eta \left(\frac{d v_{x}}{d y} \right)^2 = 0.
\end{multline}
