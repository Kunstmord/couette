...
\begin{equation}
  v_{slip} = \sigma_{P} \frac{\eta v_{m}}{nkT}\frac{d v_{x}}{d y} + \sigma_{T}\frac{\eta}{\rho}\frac{d \ln T_{wall}}{d y},
\end{equation}
где $v_{m} = \sqrt{2kT_{wall} / m}$, коэффициент $\sigma_{P} = 1.18$, $\sigma_{T} = 1.136785$.
